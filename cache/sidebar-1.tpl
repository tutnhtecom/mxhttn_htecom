    ...
    <div class="col-md-3 sidebar rightcol">        
        <div class="wow_content wow_side_loggd_usr">
            ...
            <div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-1" alt="admin Profile Picture" src="http://localhost:8081/upload/photos/d-avatar.jpg?cache=0" >
                </div>
                <div class="title">
                    ...
                    <p>@admin</p>
                            ...
                            <a class="menu_list" href="http://localhost:8081/admin/followers" data-ajax="?link1=timeline&u=admin&type=followers">
                                <span>1</span> <span class="split-link"><b>Followers</b></span>
                            </a>
                        </li>
                        •
                                        <li>
                        <a class="menu_list" href="http://localhost:8081/admin" data-ajax="?link1=timeline&u=admin">
                            <span id="user_post_count">1</span> <span class="split-link"><b>posts</b></span>
                        </a>
                    </li>
                                                                • <li>
                            <a class="menu_list" href="http://localhost:8081/admin/following" data-ajax="?link1=timeline&u=admin&type=following">
                                <span>0</span> <span class="split-link"><b>Following</b></span>
                            </a>
                        </li>
                                    </ul>
            
            <div class="wo_side_users">
                                    <a class="user" data-ajax="?link1=timeline&u=AnhQuan" href="http://localhost:8081/AnhQuan"><img src="http://localhost:8081/upload/photos/d-avatar.jpg?cache=0"></a>
                            </div>
                                                </div>    <div class="featured-users">
        <li class="list-group-item sidebar-title-back" contenteditable="false">
                            <a class="pro-me-here pull-right" href="http://localhost:8081/go-pro" data-ajax="?link1=go-pro">Put Me Here</a>
                        Pro Members 💫
        </li>
...
<ul class="list-group wow_side_invite_prnt">
            ...
            <form action="#" method="post" class="invite-user-form">
                ...
                <div class="wow_form_fields invite-user-combine">
                    ...
                    <button class="btn btn-main">Invite</button>
                </div>
                <div class="clear"></div>
            </form>
        </div>
                ...
                <ul class="list-group">
            <li class="list-group-item text-muted sidebar-title-back" contenteditable="false"><a href="http://localhost:8081/products" data-ajax="?link1=products">Market</a></li>
    ...
    <div id="sidebar-sticky">
            ...
            <li class="activities-wrapper" id="activities-wrapper">
                <div class="activity wow_side_acts " data-activity-id="1">
	<div class="notification-list">
		<div class="notification-user-avatar pull-left">
			<a href="http://localhost:8081/AnhQuan" data-ajax="?link1=timeline&u=AnhQuan" title="#"><img src="http://localhost:8081/upload/photos/d-avatar.jpg?cache=0" alt="http://localhost:8081/upload/photos/d-avatar.jpg?cache=0Profile picture"></a>
		...
		<div class="notification-text wo_sidebar_activity">
			...
			started following <a class="second-user-color" data-ajax="?link1=timeline&u=admin" href="http://localhost:8081/admin">admin</a>			<div class="notification-time active">
				<span class="ajax-time" title="2025-04-08T02:37:28+00:00">
					3 d				</span>
			</div>
			</div>
		</div>
...
<div class="page-margin">
	<div class="footer-wrapper-sidebar">
		...
		<ul class="list-inline">
			<li><a data-ajax="?link1=terms&type=about-us" href="http://localhost:8081/terms/about-us">About</a></li>
                            <li><a href="http://localhost:8081/directory" data-ajax="?link1=directory">Directory</a></li>
            							<li><a href="http://localhost:8081/blogs">Blog</a></li>
						<li><a data-ajax="?link1=contact-us" href="http://localhost:8081/contact-us">Contact Us</a></li>
							<li><a data-ajax="?link1=developers" href="http://localhost:8081/developers">Developers</a></li>
						<li>
				<div class="dropdown dropup sun_foot_drop_menu">
					...
					<ul class="dropdown-menu dropdown-menu-right" role="menu">
						<li><a data-ajax="?link1=terms&type=privacy-policy" href="http://localhost:8081/terms/privacy-policy">Privacy Policy</a></li>
						<li><a data-ajax="?link1=terms&type=terms" href="http://localhost:8081/terms/terms">Terms of Use</a></li>
													<li><a data-ajax="?link1=terms&type=refund" href="http://localhost:8081/terms/refund">Request a Refund</a></li>
																	</ul>
				</div>
			</li> 
		</ul>
