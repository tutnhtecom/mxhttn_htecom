                ...
                <div class="title">
                    ...
                    <p>@admin</p>
                            ...
                            <ul class="wo_user_side_info">
                                            <li>
                            <a class="menu_list" href="http://localhost:8081/admin/followers" data-ajax="?link1=timeline&u=admin&type=followers">
                                <span>2</span> <span class="split-link"><b>Người theo dõi</b></span>
                            </a>
                        </li>
                        •
                                        <li>
                        <a class="menu_list" href="http://localhost:8081/admin" data-ajax="?link1=timeline&u=admin">
                            <span id="user_post_count">13</span> <span class="split-link"><b>bài viết</b></span>
                        </a>
                    </li>
                                                                • <li>
                            <a class="menu_list" href="http://localhost:8081/admin/following" data-ajax="?link1=timeline&u=admin&type=following">
                                <span>2</span> <span class="split-link"><b>Tiếp theo</b></span>
                            </a>
                        </li>
                                    </ul>
            
            <div class="wo_side_users">
                                    <a class="user" data-ajax="?link1=timeline&u=ngoctusoftware" href="http://localhost:8081/ngoctusoftware"><img src="http://localhost:8081/upload/photos/d-avatar.jpg?cache=0"></a>
                                    <a class="user" data-ajax="?link1=timeline&u=ntsoftware" href="http://localhost:8081/ntsoftware"><img src="http://localhost:8081/upload/photos/f-avatar.jpg?cache=0"></a>
                            </div>
                                                </div><ul class="list-group trending">
    <li class="list-group-item sidebar-title-back" contenteditable="false">xu hướng ⚡️</li>
            <li class="list-group-item wow_htag">
            <a href="http://localhost:8081/hashtag/nhabimmoc" data-ajax="?link1=hashtag&hash=nhabimmoc">
                ...
                <div>
                    <span class="htag_top">#nhabimmoc</span>
...
<ul class="list-group wow_side_invite_prnt">
            ...
            <svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1 15.8774C1 13.8752 2.45485 12.1697 4.43204 11.8542L4.61013 11.8257C6.19336 11.5731 7.80664 11.5731 9.38987 11.8257L9.56796 11.8542C11.5451 12.1697 13 13.8752 13 15.8774C13 16.7428 12.2984 17.4443 11.433 17.4443H2.56697C1.70156 17.4443 1 16.7428 1 15.8774Z" stroke="currentColor" stroke-width="1.5" />
                <path d="M10.5 4.94434C10.5 6.87733 8.933 8.44434 7 8.44434C5.067 8.44434 3.5 6.87733 3.5 4.94434C3.5 3.01134 5.067 1.44434 7 1.44434C8.933 1.44434 10.5 3.01134 10.5 4.94434Z" stroke="currentColor" stroke-width="1.5" />
                <path d="M13 8.44434C14.933 8.44434 16.5 6.87733 16.5 4.94434C16.5 3.01134 14.933 1.44434 13 1.44434M15.3899 17.4443H17.433C18.2984 17.4443 19 16.7428 19 15.8774C19 13.8752 17.5451 12.1697 15.568 11.8542V11.8542C15.4494 11.8352 15.3293 11.8257 15.2093 11.8257C14.8895 11.8257 14.7902 11.8257 14.2412 11.8257" class="icon_main" stroke-width="1.5" stroke-linecap="round" />
            </svg>&nbsp;&nbsp;&nbsp;
            <p>1 Người dùng trực tuyến</p>
        </div>
                <div class="wow_side_invite">
            <div class="wow_side_invite_hdr">
            ...
            <form action="#" method="post" class="invite-user-form">
                ...
                <div class="wow_form_fields invite-user-combine">
                    ...
                    <button class="btn btn-main">Mời</button>
                </div>
                <div class="clear"></div>
            </form>
        </div>
    </ul>    <div id="sidebar-latest-products" class="sidebar-latest-products">
                <ul class="list-group">
            <li class="list-group-item text-muted sidebar-title-back" contenteditable="false"><a href="http://localhost:8081/products" data-ajax="?link1=products">Thị trường</a></li>
    ...
    <div id="sidebar-sticky">
            ...
            <li class="activities-wrapper" id="activities-wrapper">
                <div class="activity wow_side_acts " data-activity-id="5">
	<div class="notification-list">
		<div class="notification-user-avatar pull-left">
			<a href="http://localhost:8081/ngoctusoftware" data-ajax="?link1=timeline&u=ngoctusoftware" title="#"><img src="http://localhost:8081/upload/photos/d-avatar.jpg?cache=0" alt="http://localhost:8081/upload/photos/2025/04/KAWUB7mPPPfu6pkPP8C9_11_94fb6656679375491ff0c0fe4c311087_avatar.jpg?cache=0Profile picture"></a>
		...
		<div class="notification-text wo_sidebar_activity">
			...
			<span class="user-popover" data-id="3" data-type="user">
				<a class="main-color" href="http://localhost:8081/ngoctusoftware " data-ajax="?link1=timeline&u=ngoctusoftware">
					ngoctusoftware				</a>
			</span>
			đã bắt đầu theo dõi <a class="second-user-color" data-ajax="?link1=timeline&u=admin" href="http://localhost:8081/admin">Trần Ngọc Tú</a>			<div class="notification-time active">
				<span class="ajax-time" title="2025-04-08T03:20:44+00:00">
					3 d				</span>
			</div>
			</div>
		</div>
...
</div><div class="activity wow_side_acts " data-activity-id="1">
	<div class="notification-list">
		<div class="notification-user-avatar pull-left">
			<a href="http://localhost:8081/ntsoftware" data-ajax="?link1=timeline&u=ntsoftware" title="#"><img src="http://localhost:8081/upload/photos/f-avatar.jpg?cache=0" alt="http://localhost:8081/upload/photos/2025/04/KAWUB7mPPPfu6pkPP8C9_11_94fb6656679375491ff0c0fe4c311087_avatar.jpg?cache=0Profile picture"></a>
			<span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user-plus active"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg></span>
		</div>
		<div class="notification-text wo_sidebar_activity">
			<div>
...
<div class="page-margin">
	<div class="footer-wrapper-sidebar">
		<div class="footer-powered">
			<p>
				© 2025 Mạng xã hội thanh thiếu niên			</p>
		...
		<ul class="list-inline">
			<li><a data-ajax="?link1=terms&type=about-us" href="http://localhost:8081/terms/about-us">Về</a></li>
                            <li><a href="http://localhost:8081/directory" data-ajax="?link1=directory">Danh mục</a></li>
            							<li><a href="http://localhost:8081/blogs">Blog</a></li>
						<li><a data-ajax="?link1=contact-us" href="http://localhost:8081/contact-us">Liên hệ chúng tôi</a></li>
							<li><a data-ajax="?link1=developers" href="http://localhost:8081/developers">Nhà phát triển</a></li>
						<li>
				<div class="dropdown dropup sun_foot_drop_menu">
					...
					<ul class="dropdown-menu dropdown-menu-right" role="menu">
						<li><a data-ajax="?link1=terms&type=privacy-policy" href="http://localhost:8081/terms/privacy-policy">Chính sách bảo mật</a></li>
						<li><a data-ajax="?link1=terms&type=terms" href="http://localhost:8081/terms/terms">Điều khoản sử dụng</a></li>
													<li><a data-ajax="?link1=terms&type=refund" href="http://localhost:8081/terms/refund">Yêu cầu hoàn lại</a></li>
																	</ul>
				</div>
			</li> 
		</ul>
