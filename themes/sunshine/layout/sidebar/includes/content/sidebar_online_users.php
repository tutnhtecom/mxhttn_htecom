<!-- <ul class="list-group wow_side_invite_prnt">
    <?php if ($wo['config']['online_sidebar'] == 1) { ?>
        ...
        <div class="wow_side_online">
            ...
            <p><?php echo $online; ?> <?php echo $wo['lang']['online_users']; ?></p>
        </div>
    <?php } ?>
    <?php if ($wo['loggedin']) { ?>
        <div class="wow_side_invite">
            <div class="wow_side_invite_hdr">
                ...
                <p><?php echo $wo['lang']['invite_your_frineds_home']; ?></p>
            </div>
